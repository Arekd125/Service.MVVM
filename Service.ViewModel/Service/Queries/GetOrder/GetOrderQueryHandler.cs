...
{
    public class GetOrderQueryHandler : IRequestHandler<GetOrderQuery, CreateOrderDto>
    {
        ...
        public async Task<CreateOrderDto> Handle(GetOrderQuery request, CancellationToken cancellationToken)
        {
